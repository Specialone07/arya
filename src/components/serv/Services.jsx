...
const Services = () => {
  ...
  const truncateContent = (content, index) => {
    ...
    const wordLimit = 19; // Define the word limit here
  ...
  return (
    <div className="py-20 text-justify bg-[#ebedee]">
          ...
          <Link to="/cloud">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p>
                  {expandedCard === 3
                    ? "Unlock the power of the cloud and simplify your data management with our expert understand cloud space setup services. We provide secure, scalable, and accessible storage solutions for your business, allowing you to store and access your data from anywhere, anytime. Our team will carefully assess your needs and recommend the most suitable cloud platform, ensuring optimal performance and cost-efficiency. We'll handle the entire migration process seamlessly, minimizing downtime and disruption. Embrace the flexibility and scalability of the cloud with our expert guidance, empowering your team to collaborate efficiently and access critical information instantly."
                    : truncateContent(
                        "Unlock the power of the cloud and simplify your data management with our expert understand cloud space setup services. We provide secure, scalable, and accessible storage solutions for your business, allowing you to store and access your data from anywhere, anytime."
                      )}
                </p>
                {expandedCard !== 3 && (
                  <button
          ...
          <Link to="/dm">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p>
                  {expandedCard === 5
                    ? "Is your brand invisible online? We will craft a winning digital marketing strategy that gets your brand noticed knowingly and amazingly drives results. From targeted social media campaigns to effective search engine optimization (SEO), we'll reach your ideal audience and build lasting brand awareness. We don't just create logos and slogans – we develop a complete brand identity that resonates with your customers and tells your unique story. Let us unlock the full potential of your brand and connect you with your target audience."
                    : truncateContent(
                        "Is your brand invisible online? We will craft a winning digital marketing strategy that manage your brand noticed thoroghly and amazingly drives further results. From targeted social media campaigns to effective search engine optimization (SEO), we'll reach your ideal audience and build lasting brand awareness."
                      )}
                </p>
                {expandedCard !== 5 && (
                  <button
