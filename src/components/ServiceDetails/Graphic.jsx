  ...
  return (
    <div className="flex flex-col md:flex-row bg-white">
      ...
      <div className="w-full md:w-1/2 bg-white p-4 md:ml-10 mt-10">
        <div>
          <h2 className="text-lg font-Roboto mb-2">Graphics Designing</h2>
          <div className="mb-6 font-Poppins font-semibold">
            <h1>Graphics Designing Company in Dubai</h1>
          </div>
          <p className="text-justify">
            n today's fast-paced world, bold visuals are the language of
            connection. We believe graphic design is more than just aesthetics;
            it's a powerful tool to communicate effectively, engage your
            audience, and build lasting emotional connections. From concept to
            creation, our passionate designers craft compelling stories with
            every element. We meticulously select colors, shapes, and fonts that
            harmoniously align with your unique brand identity, ensuring your
            visual presence resonates deeply with your target audience. Whether
            you need a website that captivates, a logo that speaks volumes, or
            marketing materials that leave a lasting impression, we have the
            expertise and creativity to elevate your visual presence across all
            platforms. Partner with us and let your brand speak volumes,
            visually.
          </p>
