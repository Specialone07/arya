...
const Feat = () => {
  return (
    <div class="font-[sans-serif] text-black bg-none py-12 px-4">
      <div class="max-w-7xl mx-auto">
      <h2 class="sm:text-4xl text-2xl font-extrabold text-center mb-16">
    Discover Our <span className="text-purple-500"> Exclusive Features</span>
</h2>
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-lg mx-auto">
          <div class="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
            ...
            <p class="text-black-300 font-bold group-hover:text-gray-500 text-sm">
